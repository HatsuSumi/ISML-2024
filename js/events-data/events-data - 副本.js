const phases = new Set(['主赛事提名阶段', '预选赛阶段', '第一阶段', '第二阶段', '第三阶段', '第四阶段', '淘汰赛阶段']);
let observer;
let eventsData;
...
document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        nav.innerHTML = `
            <ul>
                <li><a href="#主赛事提名阶段" data-target="主赛事提名阶段">主赛事提名阶段</a></li>
                <li><a href="#预选赛阶段" data-target="预选赛阶段">预选赛阶段</a></li>
                <li><a href="#第一阶段" data-target="第一阶段">第一阶段</a></li>
                <li><a href="#第二阶段" data-target="第二阶段">第二阶段</a></li>
                <li><a href="#第三阶段" data-target="第三阶段">第三阶段</a></li>
                <li><a href="#第四阶段" data-target="第四阶段">第四阶段</a></li>
                <li><a href="#淘汰赛阶段" data-target="淘汰赛阶段">淘汰赛阶段</a></li>
            </ul>
        `;
        ...
        <div class="group-header">
            <div class="group-info">
                ...
                <div class="group-date">
                    ${formatDateTime(groupData[0].event.dateRange.start)} - ${formatDateTime(groupData[0].event.dateRange.end)}${firstEvent.dateRange.result ? ` | 结果公布：${formatDateTime(firstEvent.dateRange.result, 'date')}` : ''}
                </div>
            </div>
