...
window.downloadFile = function(format) {
    const filePath = format === 'csv' ? '../../data/nomination/nova/summer/female/07-nova-summer-female-nomination.csv' : 
                     format === 'xlsx' ? '../../data/nomination/nova/summer/female/07-nova-summer-female-nomination.xlsx' :
