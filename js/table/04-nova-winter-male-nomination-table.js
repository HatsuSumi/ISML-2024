...
window.downloadFile = function(format) {
    const filePath = format === 'csv' ? '../../data/nomination/nova/winter/male/04-nova-winter-male-nomination.csv' : 
                     format === 'xlsx' ? '../../data/nomination/nova/winter/male/04-nova-winter-male-nomination.xlsx' :
