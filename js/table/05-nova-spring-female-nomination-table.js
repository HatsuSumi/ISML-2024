...
window.downloadFile = function(format) {
    const filePath = format === 'csv' ? '../../data/nomination/nova/spring/female/05-nova-spring-female-nomination.csv' : 
                     format === 'xlsx' ? '../../data/nomination/nova/spring/female/05-nova-spring-female-nomination.xlsx' :
