...
def csv_to_json():
    try:
        # 读取CSV文件
        csv_file = os.path.join(root_dir, 'data', 'nomination', 'nova', 'spring', 'male', '06-nova-spring-male-nomination.csv')
        ...
        # 保存为JSON文件
        json_file = os.path.join(root_dir, 'data', 'nomination', 'nova', 'spring', 'male', '06-nova-spring-male-nomination.json')
