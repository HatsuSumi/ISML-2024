...
# 输入和输出文件路径
input_file = os.path.join(root_dir, 'data', 'nomination', 'nova', 'summer', 'male', 'male.txt') 
input_file_en = os.path.join(root_dir, 'data', 'nomination', 'nova', 'summer', 'male', 'male_en.txt')
excel_file = os.path.join(root_dir, 'data', 'nomination', 'nova', 'summer', 'male', '08-nova-summer-male-nomination.xlsx')
