...
csv_path = os.path.join(root_dir, 'data', 'nomination', 'nova', 'spring', 'female', '05-nova-spring-female-nomination.csv')
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="button-container">
                ...
                <a href="../tables/05-nova-spring-female-nomination-table.html" class="table-btn">查看表格</a>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {{
                    ...
                    title.textContent = '01.14-01.21 - 新星组春季赛提名-女性组别（未晋级）';
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '05-nova-spring-female-nomination-eliminate.html')
