...
csv_path = os.path.join(root_dir, 'data', 'nomination', 'nova', 'summer', 'female', '07-nova-summer-female-nomination.csv')
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '07-nova-summer-female-nomination-advance.html')
