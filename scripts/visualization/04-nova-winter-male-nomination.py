    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="button-container">
                ...
                <a href="../tables/04-nova-winter-male-nomination-table.html" class="table-btn">查看表格</a>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {{
                    ...
                    title.textContent = '01.07-01.14 - 新星组冬季赛提名-男性组别';
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '04-nova-winter-male-nomination.html')
