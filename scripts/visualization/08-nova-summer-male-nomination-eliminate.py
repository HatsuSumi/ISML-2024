...
csv_path = os.path.join(root_dir, 'data', 'nomination', 'nova', 'summer', 'male', '08-nova-summer-male-nomination.csv')
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="button-container">
                ...
                <a href="../tables/08-nova-summer-male-nomination-table.html" class="table-btn">查看表格</a>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {{
                    ...
                    title.textContent = '01.21-01.28 - 新星组夏季赛提名-男性组别（未晋级）';
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '08-nova-summer-male-nomination-eliminate.html')
