...
csv_path = os.path.join(root_dir, 'data', 'nomination', 'nova', 'winter', 'male', '04-nova-winter-male-nomination.csv')
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '04-nova-winter-male-nomination-advance.html')
