...
csv_path = os.path.join(root_dir, 'data', 'nomination', 'nova', 'winter', 'female', '03-nova-winter-female-nomination.csv')
df = pd.read_csv(csv_path, encoding='utf-8')

df['得票数'] = pd.to_numeric(df['得票数'].replace('-', '0'))

df_voted = df[(df['得票数'] > 0) & (df['是否晋级'] == True)].sort_values('得票数', ascending=False)
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="button-container">
                ...
                <a href="../tables/03-nova-winter-female-nomination-table.html" class="table-btn">查看表格</a>
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '03-nova-winter-female-nomination-advance.html')
