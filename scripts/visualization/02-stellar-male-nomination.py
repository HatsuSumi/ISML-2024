...
advance_data = [v if i >= len(votes) - 99 else None for i, v in enumerate(votes)]
eliminate_data = [v if i < len(votes) - 99 else None for i, v in enumerate(votes)]
        ...
        <div class="content-wrapper">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {{
                    ...
                    title.textContent = '12.31-01.07 - 恒星组提名-男性组别';
                    ...
                    subtitle.textContent = '前99名晋级至主赛事恒星组预选赛阶段';
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '02-stellar-male-nomination.html')
